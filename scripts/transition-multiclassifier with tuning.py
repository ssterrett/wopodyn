...
if __name__ == "__main__":
    ...
    # grid_params = { 'n_neighbors' : [2,3,4,5,6,7], 'weights' : ['uniform','distance'],
    ...
    for file in filenames:
        ...
        x_train_c, x_test_curr, y_train_c, y_test_curr = train_test_split(x[start:end], y[start:end], random_state = 0)
        clsfr = KNeighborsClassifier(metric='manhattan', n_neighbors=3, weights='distance')
        clsfr.fit(x_train_c, y_train_c)
